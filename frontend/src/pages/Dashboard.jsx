    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        ...
        <FinancialCard
          ...
          addictionalContent={
            <div className="mt-2 text-xs text-cyan-700 flex items-center gap-2">
              ...
              {typeof overviewMeta.savingsRate === "number" && (
                <span
                  className={`px-2 py-1 rounded-full text-xs font-medium ${overviewMeta.savingsRate < 0 ? trendStyles.negativeRate : trendStyles.positiveRate}`}
                >
